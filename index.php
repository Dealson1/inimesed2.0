    ...
    <div class="container">
        <table>
            ...
            <tr>
                ...
                <?php if(isAdmin()){ ?><th>Redigeeremine</th><?php }?>
            </tr>
            </thead>
            <tbody>
            <?php foreach($people as $person): ?>
        ...
        if (isset($_SESSION["unimi"])){
            ...
            <form action="index.php">
                ...
                <dl>
                    <dt>Maakonna nimi:</dt>
                    <dd><input type="text" name="maakonna_nimi" placeholder="Sisesta nimi..." pattern="[A-Za-z]{3,}"></dd>
                    <dt>Maakonna keskus:</dt>
                    <dl><input type="text" name="maakonna_keskus" placeholder="Sisesta keskus..." pattern="[A-Za-z]{3,}"></dl>
            ...
            <form action="index.php">
                ...
                <dl>
                    <dt>Eesnimi:</dt>
                    <dd><input type="text" name="eesnimi" placeholder="Sisesta eesnimi..." pattern="[A-Za-z]{3,}"></dd>
                    <dt>Perekonnanimi:</dt>
                    <dd><input type="text" name="perekonnanimi" placeholder="Sisesta perekonna nimi..." pattern="[A-Za-z]{3,}"></dd>
                    <dt>Maakond</dt>
                    <dd><?php
